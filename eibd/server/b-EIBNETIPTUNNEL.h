...
eibnetiptunnel_Create (const char *dev, int flags, Logs * t,
	                                ...
	                                IPv4NetList &ipnetfilters)
{
  ...
  iface = new EIBNetIPTunnel (a, dport, sport, d, dataport, flags, t, inquemaxlen, outquemaxlen, peerquemaxlen,ipnetfilters);
  free (a);
  return iface;
}
...
inline Layer2Interface *
eibnetiptunnelnat_Create (const char *dev, int flags, Logs * t,
	       int inquemaxlen, int outquemaxlen, int maxpacketsoutpersecond, int peerquemaxlen,
               IPv4NetList &ipnetfilters)
{
  char *a = strdup (dev);
  char *b;
  ...
  iface = new EIBNetIPTunnel (a, dport, sport, "0.0.0.0", -1, flags, t, inquemaxlen, outquemaxlen, peerquemaxlen, ipnetfilters);
  free (a);
  return iface;
}
