...
ft12_Create (const char *dev,  int flags, Logs * t,
	     int inquemaxlen,
	     int outquemaxlen,
             ...
             IPv4NetList &ipnetfilters)
{
  ...
  return new EMILayer2Interface(new FT12LowLevelDriver(dev, t, flags,
  inquemaxlen, outquemaxlen, maxpacketsoutpersecond), flags, t, inquemaxlen,
      outquemaxlen);
}
