...
#define AGARG_BOOLa(name, args) int name KAG ## args
#define AGARG_BOOLb(name, args) int name KAG ## args
...
#define ALARG_BOOLa(name, args) name KAL ## args
#define ALARG_BOOLb(name, args) name KAL ## args
