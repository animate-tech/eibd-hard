    ...
    int maxpacketsoutpersecond)
{
  ...
  if (!USBInit (t)) {
      ERRORLOGSHAPE (t, LOG_ERR, Logging::DUPLICATESMAX1PER10SEC, NULL, Logging::MSGNOHASH,
                                                      "USB create failed: USBInit failed");
                throw Exception (DEV_OPEN_FAIL);
  }
  return initUSBDriver (new
      USBLowLevelDriver (dev, t, flags, inquemaxlen, outquemaxlen,
      maxpacketsoutpersecond, emptylist), t, flags, inquemaxlen, outquemaxlen,
