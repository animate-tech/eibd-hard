...
PEI16s_ll_Create (const char *dev, Logs * t, int inquemaxlen, int outquemaxlen, int maxpacketsoutpersecond)
{
  return new BCU1SerialLowLevelDriver (dev, t, inquemaxlen, outquemaxlen, maxpacketsoutpersecond);
}
