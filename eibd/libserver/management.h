...
{
public:
    Management_Individual (Layer3 * l3, Logs * tr,
			   eibaddr_t dest,
				 int inquemaxlen =QUEUE_UNLIMITED_LEN,
				 int outquemaxlen =QUEUE_UNLIMITED_LEN,
				 int peerquemaxlen =QUEUE_UNLIMITED_LEN):Layer7_Individual (l3, tr, dest, inquemaxlen, outquemaxlen, peerquemaxlen)
  {
  }
};
