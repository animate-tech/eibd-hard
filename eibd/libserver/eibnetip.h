...
class EIBNetIPPacket : public LoggableObjectInterface
{
...
class _EIBNetIP_Send : public LoggableObjectInterface
{
public:
  /** packat */
  EIBNetIPPacket data;
...
/** EIBnet/IP socket */
class EIBNetIPSocket:private Thread, public DroppableQueueInterface, public StateInterface
{
  /** input queue */
    Queue < _EIBNetIP_Send >inqueue;
    /** output queue */
...
public:
    EIBNetIPSocket (struct sockaddr_in bindaddr, bool reuseaddr,
		    Logs * tr,
  ...
  const char *_str(void) const { return "IP socket"; }
