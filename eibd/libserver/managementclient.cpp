...
void
ReadIndividualAddresses (Layer3 * l3, Logs * t, ClientConnection * c,
			 pth_event_t stop)
{
...
void
ChangeProgMode (Layer3 * l3, Logs * t, ClientConnection * c,
		pth_event_t stop)
{
  eibaddr_t dest;
  uchar res[3];
...
void
GetMaskVersion (Layer3 * l3, Logs * t, ClientConnection * c,
		pth_event_t stop)
{
  eibaddr_t dest;
  uchar res[4];
...
void
WriteIndividualAddress (Layer3 * l3, Logs * t, ClientConnection * c,
			pth_event_t stop)
{
  eibaddr_t dest;
  uint16_t maskver;
...
void
ManagementConnection (Layer3 * l3, Logs * t, ClientConnection * c,
		      pth_event_t stop)
{
  eibaddr_t dest;
  uint16_t maskver;
...
void
ManagementIndividual (Layer3 * l3, Logs * t, ClientConnection * c,
		      pth_event_t stop)
{
  eibaddr_t dest;
  uint16_t maskver;
...
void
LoadImage (Layer3 * l3, Logs * t, ClientConnection * c, pth_event_t stop)
{
  uchar buf[200];
